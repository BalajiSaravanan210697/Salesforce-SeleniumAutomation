...
public class EditWorkType extends BaseClass{
	...
	public void editExistingWorkType()
	{
		...
		waitForClickalbe(By.xpath("//*[.='Salesforce Project']/ancestor::tr//a[@class='rowActionsPlaceHolder slds-button slds-button--icon-x-small slds-button--icon-border-filled keyboardMode--trigger']")).click();
		...
		waitForClickalbe(By.xpath("//div[contains(@id,'toastDescription')]/span"));
