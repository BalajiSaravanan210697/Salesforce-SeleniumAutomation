...
public class TC02_EditOpportunity extends BaseClass {
	...
	public void editOpportunity() throws InterruptedException {
		...
		driver.findElement(By.xpath("//div[contains(@class,'slds-datepicker')]//span[text()='" + (date + 1) + "']"))
				.click();
		...
		Thread.sleep(1000);
		WebElement stageStatusElement = driver
				.findElement(By.xpath("(//table//tr/td)[5]//span[@class='slds-truncate']"));

		// wait.until(ExpectedConditions.textToBePresentInElementValue(stageStatusElement,
		// stageStatusUpdate));
